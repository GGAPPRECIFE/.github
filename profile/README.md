...
<table>
  <tr>
    <td align="center">
      <img src="/img/mayres.jpg" width="100px;" style="border-radius:50%;"/><br>
      <b>Mayres Pequeno</b><br>
      <i>Gerente Geral</i><br>
  ...
  <tr>
    <td align="center">
      <img src="/img/Elaine.jpg" width="100px;" style="border-radius:50%;"/><br>
      <b>Elaine Veras</b><br>
...
## Linha do tempo
<div align="center">
  <img alt="linha do tempo" src="/img/linha_do_tempo_horizontal.png">
</div>

| <b>2021</b> | | <b>2022</b> |
| :--- | :---: | :--- |
| Pioneiro no âmbito municipal, a Gerência de Avaliação de Políticas Públicas foi incorporada à Secretaria de Planejamento, Gestão e Transformação Digital. | **Atividades** | Com o Núcleo e seu escopo definidos, em 2022 foram entregues importantes Avaliações e firmadas grandes parcerias, além de mais atividades nos eixos de Ciência de Dados e premiações. |
| *Atividades nos eixos: Avaliação, Ciência de Dados, parcerias e premiações.* | | |
...
**Políticas Públicas**
* Identificação do Problema: Avaliação de Necessidades e Diagnóstica
* Formulação da Política: Teoria da Mudança e Avaliação de Desenho
* Implementação: Avaliação Sintética e Executiva Participativa
* Avaliação de Resultados, Impacto e Custo-Benefício

**Ciência de Dados**
* Geração, Tratamento, Análise e Visualização de Dados
* Análise Preditiva

**Parcerias Institucionais**
* Instituições Acadêmicas, Terceiro Setor e Internacionais

**Divulgação de Conhecimento**
* Formação, Capacitação e Participação em iniciativas

---

## Participações e Eventos

A GGAPP participa ativamente de diversas iniciativas, como:

#### Iniciativas
* Participação no lançamento da iniciativa CLEAR Nordeste como o único representante municipal.

#### Oficinas, Workshops e Cursos
* Oficina de Sistemas de Monitoramento e Avaliação;
* Workshop de Avaliação de Desenho;
* Curso de Avaliação Executiva.

#### Prêmios e Convocatórias
* Prêmio Evidências – CREDPOP;
